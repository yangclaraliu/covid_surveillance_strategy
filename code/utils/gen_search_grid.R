gen_search_grid <- function(param_outbreak_tmp){
  ...
  search_grid_tmp <- vector("list", nrow(hcw_RR))
  names(search_grid_tmp) <- 1:nrow(hcw_RR)
  ...
  for(t in 2:nrow(hcw_RR)){
    cbind(
      ...
      # Numerator = Infectious and Symptomatic 
      # Denominator = All respiratory patients + Infectious and Symptomatic 
      sapply(n_test, function(x) phyper(q = 0.1,
                                        m = tmp$Io[t]*sen["chau_c_early"],
                                        n = tmp$n_denom_rd[t] - 
                                          tmp$Io[t]*sen["chau_c_early"],
      ...
      sapply(n_test, function(x) phyper(q = 0.1,
                                        m = (tmp$n_COVID19_child_Ip[t]*sen["chau_c_early"] +
                                               ...
                                               tmp$n_COVID19_child_Ro_pos[t]*sen["chau_c_late"] +
                                               tmp$n_COVID19_child_Ru_pos[t]*sen["chau_sc_late"]),
      ...
      sapply(n_test, function(x) phyper(q = 0.1,
                                        m = (tmp$n_COVID19_adult_Ip[t]*sen["chau_c_early"] +
                                               ...
                                               tmp$n_COVID19_adult_Ro_pos[t]*sen["chau_c_late"] +
                                               tmp$n_COVID19_adult_Ru_pos[t]*sen["chau_sc_late"]),
      ...
      sapply(n_test, function(x) phyper(q = 0.1,
                                        m = (tmp$n_COVID19_elderly_Ip[t]*sen["chau_c_early"] +
                                               ...
                                               tmp$n_COVID19_elderly_Ro_pos[t]*sen["chau_c_late"] +
                                               tmp$n_COVID19_elderly_Ru_pos[t]*sen["chau_sc_late"]),
                                        n = (tmp$n_denom_elderly[t] - 
                                               (tmp$n_COVID19_elderly_Ip[t]*sen["chau_c_early"] +
                                                  ...
                                                  tmp$n_COVID19_elderly_Ro_pos[t]*sen["chau_c_late"] +
                                                  tmp$n_COVID19_elderly_Ru_pos[t]*sen["chau_sc_late"])),
                                        k = x))) -> search_grid_tmp[[t]]
    
    pb$tick()
  }
  return(search_grid_tmp) 
}